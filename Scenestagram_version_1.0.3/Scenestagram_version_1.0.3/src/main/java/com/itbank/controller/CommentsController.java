...
public class CommentsController {
	...
	@GetMapping("/getComments/{post_idx}")
	public List<HashMap<String, Object>> getComments(@PathVariable("post_idx") int post_idx) {
		List<HashMap<String, Object>> list = commentsService.getComments(post_idx);
		return list;
	}
