...
//		System.out.println(imageFileName);
	...
	@ResponseBody
	public PostDTO modalTest(@PathVariable("post_idx") int post_idx) {
		PostDTO dto = postService.getDetail(post_idx);
		return dto;
	}
	...
	@ResponseBody
	public PostDTO modalTest(@PathVariable("users_idx") int users_idx, @PathVariable("offset") int offset) {
