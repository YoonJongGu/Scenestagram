...
// 검색
	...
	public List<ImageDTO> getPostList(@PathVariable("offset") int offset, @PathVariable("hashtag") String hashtag) {
 ...
 // 팔로우가 있는 기준   (1촌 추천)
    ...
    public List<ImageDTO> explore(@PathVariable("offset") int offset) {
       List<ImageDTO> list = postService.explore(offset);
       System.out.println(list);
